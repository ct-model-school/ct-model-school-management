      ...
      <style>{`
        @media print {
          ...
          .sr-a4-header {
            ...
            border-bottom: 1.2px solid #17233b !important;
          ...
          .sr-a4-meta-cell {
            ...
            border-right: 1px solid #b8c0cc !important;
          }
          ...
          .sr-a4-table th,
          .sr-a4-table td {
            border: 1px solid #aeb7c5 !important;
          ...
          .col-item { width: 24% !important; }
          .col-spec { width: 35% !important; }
          ...
          .col-issued { width: 8.5% !important; text-align: center !important; }
          .sr-a4-item-name { font-size: 6.5px !important; font-weight: 800 !important; }
          .sr-a4-code { margin-top: 1px !important; font-size: 5px !important; color: #475569 !important; }
          .sr-a4-sub, .sr-a4-note { margin-top: 1px !important; font-size: 5.2px !important; color: #334155 !important; }
          .sr-a4-admin {
            margin-top: 4px !important;
            padding: 2px 0 !important;
            border-top: 1px dashed #9ca3af !important;
          }
          .sr-a4-admin strong { font-size: 5px !important; color: #475569 !important; text-transform: uppercase !important; }
          .sr-a4-admin div { margin-top: 1px !important; font-size: 6.2px !important; }
          .sr-a4-footer {
            display: flex !important;
            justify-content: space-between !important;
        ...
        <div className="sr-print-modal flex max-h-[94vh] w-full max-w-4xl flex-col overflow-hidden rounded-3xl border border-[var(--school-border)] bg-[var(--school-surface)] shadow-2xl">
          ...
          <div className="sr-print-only sr-a4">
            <div className="sr-a4-header">
              <div><p className="sr-a4-school">C.T. Model School</p><h1 className="sr-a4-title">Item Service Request</h1></div>
              <div><p className="sr-a4-number">{sr.sr_number}</p><span className={`sr-a4-status ${statusClass(sr.status)}`}>{sr.status.replace(/_/g, " ")}</span></div>
            </div>
                ...
                {sr.items.map((item, index) => (
                  <tr key={item.item_id}>
                    ...
                    <td className="col-spec">
                      ...
                      {item.item_note ? <div className="sr-a4-note">Note: {item.item_note}</div> : null}
                    </td>
