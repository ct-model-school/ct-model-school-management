...
const primaryNavigation=[
  ...
  {href:"/admin/accounts",label:"Accounts",permission:"accounts"},
...
export default async function AdminLayout({children}:{children:React.ReactNode}){
  ...
  const has=(key:string)=>adminOnly||Boolean(permissions[key]); const hasInventory=has("inventory")||has("procurement"); const hasAccounts=has("accounts")||has("procurement"); const hasItemSr=has("item_sr");
