          ...
          <section className="order-2 min-w-0 rounded-3xl border border-[var(--school-border)] bg-[var(--school-surface)] p-4 shadow-sm sm:p-6 lg:p-5">
            ...
            <div className="mt-5 space-y-3">
              ...
              {visibleItems.map((item) => (
                <article key={item.id} className="rounded-2xl border border-[var(--school-border)] p-3.5">
                  <div className="flex flex-col gap-3">
                    ...
                    {item.note ? <div className="rounded-xl bg-[var(--school-background)] px-3 py-2.5"><p className="text-[10px] font-bold uppercase tracking-[0.12em] theme-primary">Note</p><p className="mt-1 whitespace-pre-wrap break-words text-xs leading-5 text-[var(--school-muted)]">{item.note}</p></div> : null}
                ...
                <div className="mt-4 space-y-3">
                  {sr.items.map((item) => (
                    <div key={item.item_id} className="rounded-xl border border-[var(--school-border)] p-3">
                      ...
                      {item.item_note ? <p className="mt-3 rounded-lg bg-[var(--school-background)] p-2 text-xs text-[var(--school-muted)]">Item note: {item.item_note}</p> : null}
