      ...
      <section className="mt-6" aria-label="Ready administration modules">
        <Link href="/admin/inventory" className="group block rounded-3xl border border-[var(--school-border)] bg-[var(--school-surface)] p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-[var(--school-primary-border)] hover:shadow-md md:p-8">
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
            <div><p className="text-[10px] font-black uppercase tracking-[0.16em] theme-primary">Ready Module</p><h2 className="mt-2 text-2xl font-black text-[var(--school-text)]">Inventory</h2><p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--school-muted)]">Manage items and handle User Service Requests from the Inventory workspace. SR approval and processing remain inside Inventory.</p></div>
          ...
          <span className="mt-6 inline-block text-xs font-bold theme-primary">Open Inventory →</span>
        </Link>
      </section>
