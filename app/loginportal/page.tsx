    ...
    <main className={styles.page}>
      ...
      <section className={styles.shell} aria-label="C.T. Model School login portal">
        <div className={styles.brandRow}>
          ...
          <div>
            <p className={styles.schoolName}>C.T. Model School</p>
            <p className={styles.systemName}>Digital Management System</p>
          </div>
        </div>
          ...
          {selected ? (
            <>
              <div className={styles.selectedHeader}>
                <div>
                  <span className={styles.selectedEyebrow}>{selected.label.toUpperCase()}</span>
                ...
                <label className={styles.field}>
                  ...
                  <div className={styles.inputWrap}>
                    ...
                    <input
                      name="memberId"
                      type="text"
                      placeholder={selected.id === "admin" ? "Enter your Admin ID" : `e.g. ${selected.prefix}000001`}
            ...
            <div className={styles.emptyState}>
              ...
              <div>
                ...
                <p>Your Member ID and password fields will appear here.</p>
              </div>
            </div>
          )}
        </div>
        ...
        <footer className={styles.footer}>
          <span>Authorized school access</span>
